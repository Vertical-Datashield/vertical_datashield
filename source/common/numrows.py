...
#Build file paths
sum_M_data_path_local  = ds_config.temp_dir+sum_M_location_local+ '/numrows.'+data_set_name
sum_M_data_path_remote = ds_config.temp_dir+sum_M_location_remote+'/numrows.'+data_set_name
